...
<div class="product-detail">
    <div class="row">
        ...
        <div class="col-lg-6">
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr class="{{ $isCurrentCity ? 'table-success fw-bold' : '' }}">
                        ...
                        <td>
                            <span class="badge {{ $warehouse->pivot->quantity > 0 ? 'bg-success' : 'bg-secondary' }}">
                                {{ $warehouse->pivot->quantity }} шт.
                            </span>
                        </td>
                    </tr>
                    @endforeach
            ...
            <p>
                <strong>Всего доступно: {{ $product->total_quantity }} шт.</strong>
            </p>
            @else
            <div class="alert alert-warning">Товар отсутствует на всех складах</div>
            @endif
        </div>
    </div>
